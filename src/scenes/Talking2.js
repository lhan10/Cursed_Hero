class Talking2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.boss = this.add.sprite(this.OFFSCREEN_X + 200, this.DBOX_Y- 20, 'Stereary').setOrigin(0, 1);
        this.bg1 = this.add.sprite(0 , 0, 'bg2').setOrigin(0);
    ...
    typeText() {
        ...
        if(this.dialogConvo >= this.dialog.length) {
            ...
            this.scene.start('talking3Scene');
