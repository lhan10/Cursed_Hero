class Map1 extends Phaser.Scene {
    ...
    create() {
        ...
        const trap2Spawn = map.findObject('Spawns', obj=> obj.name === 'trap2Spawn');
        this.trap2 = new Trap(this,trap2Spawn.x, trap2Spawn.y, 'trap', 0);
        this.trap2.setImmovable(true);
        
        const trap3Spawn = map.findObject('Spawns', obj=> obj.name === 'trap3Spawn');
        this.trap3 = new Trap(this,trap3Spawn.x, trap3Spawn.y, 'trap', 0);
        ...
        // add life text
        this.lifeText = this.add.bitmapText(5, 5, 'gem', 'HP: '+hp+'/'+max_hp+'Current shield:'+sh, 30).setOrigin(0,0).setTint(0xee2c79);
        ...
        this.physics.add.collider(this.trap2, worldLayer0);
        this.physics.add.collider(this.trap3, worldLayer0);
        ...
        this.trap2.anims.play('activate');
        this.trap3.anims.play('activate');
        ...
        this.physics.add.collider(this.hero,this.trap2, ()=>{
            this.hero.x -= 30;
            this.hero.hurt();
        },null, this);

        this.physics.add.collider(this.hero,this.trap3, ()=>{
            this.hero.x -= 30;
            this.hero.hurt();
        },null, this);


        // add outcome for collision between monsters and traps
